...
void loop()
{
  ...
  // Call the rfid function
  cardId = getCardId();

  authenticated(cardId);
}


void authenticated(String cardId)
{
  // Check if the card ID is equal to the admin card ID
  if (cardId == "123456789")
  {
...
String getCardId()
{
  ...
  if (mfrc522.PICC_ReadCardSerial())
  {
    ...
    // Print the card ID
    Serial.println("Card ID: " + cardIdDetected);
  }
