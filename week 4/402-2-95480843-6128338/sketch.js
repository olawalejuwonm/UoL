...
Officer: 6128338
CaseNum: 402-2-95480843-6128338
...
function draw() {
	...
	if (det.locationX == 266) {
		det.speedX = 0;
		det.speedY = -1;
	}

	if (det.locationX == 266 && det.locationY == 443) {
		det.speedX = 1;
		det.speedY = 0;
	}

	if (det.locationX == 512 && det.locationY == 443) {
		det.speedX = 0;
		det.speedY = -1;
	}

	if (det.locationX == 512 && det.locationY == 187) {
		det.speedX = 1;
		det.speedY = 0;
	}

	if (det.locationX == 775 && det.locationY == 187) {
		det.speedX = 0;
		det.speedY = -1;
	}

	if (det.locationX == 775 && det.locationY == 65) {
		det.speedX = 1;
		det.speedY = 0;
	}
	
	console.log(det.locationX, det.locationY);
