...
Officer: 6128338
CaseNum: 402-3-86610277-6128338
...
function draw()
{
	...
	///////////////////ADD YOUR CODE HERE///////////////////
	if (det.locationY > 197 && det.locationX == 73)
	{
		det.speedX = 0;
		det.speedY = -1;
	}
	if (det.locationX == 73 && det.locationY == 193) {
		det.speedX = 1;
		det.speedY = 0;
	}
	if (det.locationX == 257 && det.locationY == 193) {
		det.speedX = 0;
		det.speedY = 1;
	}
	if (det.locationX == 257 && det.locationY == 506) {
		det.speedX = 1;
		det.speedY = 0;
	}
	if (det.locationX == 512 && det.locationY == 506) {
// 		North: detSpeedX = 0 and detSpeedY = -1
// East: detSpeedX = 1 and detSpeedY  = 0
// South: detSpeedX = 0 and detSpeedY = 1
// West: detSpeedX = -1 and detSpeedY = 0
	...
	if (det.locationX == 512 && det.locationY == 130) {
		det.speedX = 1;
		det.speedY = 0;
	}
	if (det.locationX == 639 && det.locationY == 130) {
		det.speedX = 0;
		det.speedY = 1;
	}
	if (det.locationX == 639 && det.locationY == 567) {
		det.speedX = 1;
		det.speedY = 0;
	}
	if (det.locationX == 769 && det.locationY == 567) {
		det.speedX = 0;
		det.speedY = -1;
	}
	if (det.locationX == 769 && det.locationY == 68) {
		det.speedX = 1;
		det.speedY = 0;
	}
	if (det.locationX == 886 && det.locationY == 68) {
		det.speedX = 0;
		det.speedY = 1;
	}
