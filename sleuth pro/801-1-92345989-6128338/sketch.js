...
Officer: 6128338
CaseNum: 801-1-92345989-6128338

Our person in the box office at the Console City opera house has just informed us that the influential order of Swartz will be attending Don Giovanni tonight. This vein lot should be easy to spot thanks to their distinguished tall hair. They must be up to something kid...
...
function draw()
{
	...
	for (var i = 0; i < theatregoers.length; i++) {
		theatregoers[i][1].discovered = true;
	}
